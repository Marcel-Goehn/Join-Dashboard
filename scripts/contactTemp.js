...
function contactTemp(email, name, phone, index, rgbArr){
    return `
        <div class="actualContactDiv" onclick="openContact('${email}', '${name}', '${phone}', '${JSON.stringify(rgbArr)}')">
...
function contactInfoTemp(email, name, phone){
    return `
        <div id="contactInfoInfoHeadline">
            ...
            <div id="nameAndEditDiv">
                <h3>${name}</h3>
                <div id="editDiv">
                    <div class="editBlock" onclick="openEditContactDial()">
