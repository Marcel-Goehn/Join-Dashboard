...
function contactTemp(email, name, phone, index, rgbArr) {
	return `
        <div class="actualContactDiv" onclick="openContact('${email}', '${name}', '${phone}', '${JSON.stringify(
		rgbArr
	)}')">
	...
	return `
        <div id="contactInfoInfoHeadline">
            ...
            <div id="nameAndEditDiv">
                <h3>${name}</h3>
                <div id="editDiv">
                    <div class="editBlock" onclick="openEditContactDial('${email}', '${name}', '${phone}', '${color}')">
            ...
            <div id="editContactInfoDiv">
                ...
                <div id="contactImgAndFormDiv">
                    ...
                    <div id="contactFormDiv">
                        <form>
                            <div id="dialNameDiv" class="formDiv">
                                <input id="dialNameInput" placeholder="Name" value="${name}">
                            </div>
                            <div id="dialEmailDiv" class="formDiv">
                                <input id="dialEmailInput" placeholder="Email" value="${email}">
                            </div>
                            <div id="dialPhoneDiv" class="formDiv">
                                <input id="dialPhoneInput" placeholder="Phone" value="${phone}">
                            </div>
                        </form>
                        <div id="dialButtonDiv">
                            <button id="deleteButton">Delete</button>
                            <button id="saveBtn" onclick="updateContact('${name}')">Save<svg xmlns="http://www.w3.org/2000/svg" width="16" height="12" viewBox="0 0 16 12" fill="none">
        ...
        <div id="addContactDialContent">
            ...
            <div id="addContactInfoDiv">
                ...
                <div id="contactImgAndFormDiv">
                    ...
                    <form>
                        <div id="dialNameDiv" class="formDiv">
                            <input id="dialNameInput" placeholder="Name">
                        ...
                        <div id="dialEmailDiv" class="formDiv">
                            <input id="dialEmailInput" placeholder="Email">
                        ...
                        <div id="dialPhoneDiv" class="formDiv">
                            <input id="dialPhoneInput" placeholder="Phone">
                    ...
                    <div id="dialButtonDiv">
                    <button id="cancelButton">Cancel <svg xmlns="http://www.w3.org/2000/svg" width="14" height="13" viewBox="0 0 14 13" fill="none">
                    ...
                    <button id="createContactBtn" onclick="addContact()">Create contact <svg xmlns="http://www.w3.org/2000/svg" width="16" height="12" viewBox="0 0 16 12" fill="none">
                        <path d="M5.55057 9.15L14.0256 0.675C14.2256 0.475 14.4631 0.375 14.7381 0.375C15.0131 0.375 15.2506 0.475 15.4506 0.675C15.6506 0.875 15.7506 1.1125 15.7506 1.3875C15.7506 1.6625 15.6506 1.9 15.4506 2.1L6.25057 11.3C6.05057 11.5 5.81724 11.6 5.55057 11.6C5.28391 11.6 5.05057 11.5 4.85057 11.3L0.550573 7C0.350573 6.8 0.25474 6.5625 0.263073 6.2875C0.271407 6.0125 0.375573 5.775 0.575573 5.575C0.775573 5.375 1.01307 5.275 1.28807 5.275C1.56307 5.275 1.80057 5.375 2.00057 5.575L5.55057 9.15Z" fill="white"/></svg></button>
                </dialButtonDiv>
                </div>
                </div>
