                        ...
                        <form id="editForm" novalidate>
                            <div class="formInputWrapper">
                                <div id="editDialNameDiv" class="formDiv">
                                    <input id="editDialNameInput" placeholder="Name" value="${name}" required type="text" oninput="revertNotLetters(event)">
                ...
                <div id="contactImgAndFormDiv">
                    ...
                    <div class="formInputWrapper">
                        <div id="addDialNameDiv" class="formDiv">
                            <input id="addDialNameInput" placeholder="Name" oninput="revertNotLetters(event)">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
